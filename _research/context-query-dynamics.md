...
<div class="mermaid">
flowchart TB
  obs["Partial observations and mask M"]
  split["Split M into context and query"]
  train["Train on context and query loss"]
  part1["Work I distribution preserving split"]
  ens["Ensemble context masks at inference"]
  bfn["Work II pretrain mask prior BFN"]
  inter["Context from mask intersection"]
