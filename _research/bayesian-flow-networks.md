...
Here \\(\\hat{e}_\theta\\) predicts class-probability targets (equivalently \\(x_0/K\\)), not \\(\\epsilon\\). The schedule terms \\(w(t), \alpha_t, \sigma_t\\) should be chosen consistently.
...
- BFN–diffusion unification via SDEs: [Xue et al., Unifying Bayesian Flow Networks and Diffusion Models through Stochastic Differential Equations (arXiv:2404.15766)](https://arxiv.org/abs/2404.15766).
